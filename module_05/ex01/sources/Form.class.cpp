...
{
	std::cout << _name << " has been created by default" << std::endl;
	return;
}
...
{
	std::cout << _name << " has been created specifically" << std::endl;
...
{
	std::cout << _name << " has been created by cloning" << std::endl;
	return;
}

Form::~Form(void)
{
	std::cout << _name << " has been torn" << std::endl;
	return;
}
